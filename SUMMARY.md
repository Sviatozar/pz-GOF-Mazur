...
2. **Singleton** `src/creational/singleton/`
   - Проблема: Множественість примірників критичних об'єктів
   - Рішення: Гарантія єдиного примірника
   - Приклад: База даних, конфігурація, логер

### Структурні Патерни:
3. **Facade** `src/structural/facade/`
   - Проблема: Складна система з множеством компонентів
   - Рішення: Єдиний спрощений інтерфейс
   - Приклад: Smart Home система

4. **Decorator** `src/structural/decorator/`
   - Проблема: Експоненціальне зростання класів при комбіну властивостей
